package com.azhar.absensi.view.izin
...
import com.azhar.absensi.viewmodel.IzinViewModel
...
class IzinActivity : AppCompatActivity() {
    ...
    lateinit var izinViewModel: IzinViewModel
        ...
        fusedLocationClient.lastLocation
            .addOnSuccessListener(this) { location ->
                ...
                if (location != null) {
                    ...
                    val geocoder = Geocoder(this@IzinActivity, Locale.getDefault())
                    try {
                        val addressList =
                    ...
                    progressDialog.dismiss()
                    Toast.makeText(this@IzinActivity,
    ...
    private fun setInitLayout() {
        ...
        izinViewModel = ViewModelProvider(this, (ViewModelProvider.AndroidViewModelFactory
            .getInstance(this.application) as ViewModelProvider.Factory)).get(IzinViewModel::class.java)
        ...
        layoutImage.setOnClickListener {
            Dexter.withContext(this@IzinActivity)
                .withPermissions(
                    ...
                    override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                        if (report.areAllPermissionsGranted()) {
                            try {
                                ...
                                startActivityForResult(cameraIntent, REQ_FILE)
